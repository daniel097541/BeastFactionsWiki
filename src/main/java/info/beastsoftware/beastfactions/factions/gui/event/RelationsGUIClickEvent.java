...
public class RelationsGUIClickEvent extends FactionsGUIClickedEvent {
    public RelationsGUIClickEvent(IFPlayer fPlayer, IGUI clickedGui, Inventory clickedInventory, IPage clickedPage, ItemStack clickedItem, IButton clickedButton, IFaction faction) {
