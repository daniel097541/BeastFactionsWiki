...
public class PlayerPermissionsGUIClickedEvent extends FactionsGUIClickedEvent {
    public PlayerPermissionsGUIClickedEvent(IFPlayer fPlayer, IGUI clickedGui, Inventory clickedInventory, IPage clickedPage, ItemStack clickedItem, IButton clickedButton, IFaction faction) {
