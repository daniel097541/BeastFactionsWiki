...
public class RelationPermissionsManageGUIClickedEvent extends FactionsGUIClickedEvent {
    public RelationPermissionsManageGUIClickedEvent(IFPlayer fPlayer, IGUI clickedGui, Inventory clickedInventory, IPage clickedPage, ItemStack clickedItem, IButton clickedButton, IFaction faction) {
