...
public class FactionRoleManageGUIClickEvent extends FactionsGUIClickedEvent {
    public FactionRoleManageGUIClickEvent(IFPlayer fPlayer, IGUI clickedGui, Inventory clickedInventory, IPage clickedPage, ItemStack clickedItem, IButton clickedButton, IFaction faction) {
