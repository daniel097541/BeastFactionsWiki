...
public class FactionPlayerManageGUIClickEvent extends FactionsGUIClickedEvent {
    public FactionPlayerManageGUIClickEvent(IFPlayer fPlayer, IGUI clickedGui, Inventory clickedInventory, IPage clickedPage, ItemStack clickedItem, IButton clickedButton, IFaction faction) {
