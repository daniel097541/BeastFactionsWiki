...
public class MainPermissionsGUIClickedEvent extends FactionsGUIClickedEvent {
    public MainPermissionsGUIClickedEvent(IFPlayer fPlayer, IGUI clickedGui, Inventory clickedInventory, IPage clickedPage, ItemStack clickedItem, IButton clickedButton, IFaction faction) {
